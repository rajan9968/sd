...
export default function EditAboutBanner() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await api.get(`/resources-photo/get-resources-photo/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await api.put(`/resources-photo/update-resources-photo/${id}`, formData, {
                headers: {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => navigate('/admin/media-resources-list'), 1000);
            } else {
