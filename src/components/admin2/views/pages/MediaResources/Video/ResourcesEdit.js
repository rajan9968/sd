...
export default function EditAboutBanner() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await api.get(`/resources-video/get-resources-video/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await api.put(`/resources-video/update-resources-video/${id}`, formData, {
                headers: {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => navigate('/admin/media-resources-video-list'), 1000);
            } else {
