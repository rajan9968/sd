...
export default function AddAboutBanner() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await api.post('/resources-photo/add-resources-photo', formData, {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => {
                    navigate('/admin/media-resources-list'); // Redirect to banner list
                }, 1000);
            } else {
                    ...
                    <div className='row bg-white mx-1 mb-3 py-3 shadow-sm'>
                        <div className='col-lg-12 d-flex align-items-center'>
                            <CBreadcrumb className="mb-0">
                                <CBreadcrumbItem>
                                    <Link to="/admin/dashboard" className='text-decoration-none'>Home</Link>/ Resources Photo
                                </CBreadcrumbItem>
                            </CBreadcrumb>
                        </div>
                    </div>
