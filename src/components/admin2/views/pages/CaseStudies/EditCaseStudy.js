...
export default function EditBlogDetail() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await api.get(`/case-studies/get-case-study-detail/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await api.put(`/case-studies/update-case-study-detail/${id}`, formData, {
                ...
                <div className="body flex-grow-1 p-3">
                    ...
                    <div className="bg-white p-3">
                        <CForm className="row g-3" onSubmit={handleSubmit}>
                            ...
                            {/* Inner Image */}
                            <CCol md={6}>
                                <label className="form-label">Case Inner Image</label>
                                {oldInner && (
                                    <div className="mb-2">
                                        <img
