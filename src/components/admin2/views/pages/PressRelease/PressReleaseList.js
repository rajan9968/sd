...
export default function PressReleaseList() {
    ...
    const handleDelete = (id) => {
        if (window.confirm("Are you sure you want to delete this press release?")) {
            api
                .delete(`/press-releases/delete-press-release/${id}`)
                .then((response) => {
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="d-flex gap-2">
                    <Link to="/admin/edit-press-release" state={{ id: row.id }}>
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await api.get("/press-releases/get-press-releases");
                ...
                <div className="body flex-grow-1 p-3">
                    ...
                    <div className="row mb-3">
                        <div className="col-lg-6 d-flex align-items-center">
                            <h5 className="fw-bold mx-3 mb-0">Press Releases</h5>
                        </div>
                        <div className="col-lg-6 d-flex justify-content-end">
                            <Link to="/admin/add-press-release" className="text-decoration-none">
