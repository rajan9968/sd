...
export default function CareerList() {
    ...
    const handleDelete = (id) => {
        if (window.confirm("Are you sure you want to delete this career?")) {
            api
                .delete(`/press-banner/deletepress-banner/${id}`)
                .then((response) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) => {
                ...
                return imageFile ? (
                    <img
                        src={`http://localhost:50000/uploads/careers/${imageFile}`}
                        alt="career"
                        width="80"
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="d-flex gap-2">
                    <Link
                        to="/admin/edit-press-release-banner"
                        state={{ id: row.id }}
                    >
                ...
                <div className="body flex-grow-1 p-3">
                    ...
                    <div className='row mb-3'>
                        ...
                        <div className='col-lg-6 d-flex justify-content-end'>
                            <Link to="/admin/add-press-release-banner" className='text-decoration-none'>
                                <CButton className='custom-button text-white align-items-center d-flex gap-2'>
                                    <CIcon icon={cilPlus} size="lg" />
                                    Add Press Release Banner
                                </CButton>
                            </Link>
                        </div>
                    </div>
