...
export default function AboutBannerList() {
    ...
    const handleDelete = (id) => {
        if (window.confirm("Are you sure you want to delete this banner?")) {
            api
                .delete(`/careers-heading/delete-careers-heading/${id}`)
                .then((response) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await api.get("/careers-heading/get-careers-heading");
                ...
                <div className="body flex-grow-1 p-3">
                    ...
                    <div className='row mb-3'>
                        ...
                        <div className='col-lg-6 d-flex justify-content-end'>
                            <Link to="/admin/add-careers-heading" className='text-decoration-none'>
