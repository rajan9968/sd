...
export default function AddAboutBanner() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await api.post('/portfolio-heading/add-portfolio-heading', formData);

            if (response.data.success) {
                toast.success('Portfolio Heading created successfully!');

                setTimeout(() => {
                    navigate('/admin/portfolio-heading'); // Redirect to portfolio heading list
                }, 1000);
            } else {
