...
export default function AboutBannerList() {
    ...
    const handleDelete = (id) => {
        if (window.confirm("Are you sure you want to delete this banner?")) {
            api
                .delete(`/portfolio-heading/delete-portfolio-heading/${id}`)
                .then((response) => {
...

        {
            ...
            cell: (row) => (
                <div className="d-flex gap-2">
                    <Link
                        to="/admin/edit-portfolio-heading"
                        state={{ id: row.id }}
                    >
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await api.get("/portfolio-heading/get-portfolio-heading");
                ...
                <div className="body flex-grow-1 p-3">
                    ...
                    <div className='row mb-3'>
                        ...
                        <div className='col-lg-6 d-flex justify-content-end'>
                            <Link to="/admin/add-portfolio-heading" className='text-decoration-none'>
