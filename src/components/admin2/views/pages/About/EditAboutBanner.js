...
export default function EditAboutBanner() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await api.get(`/about-banner/get-about-banner/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await api.put(`/about-banner/update-about-banner/${id}`, formData, {
                headers: {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => navigate('/admin/about-banner'), 1000);
            } else {
