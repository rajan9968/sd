...
export default function AboutBannerList() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await api.get("/com-banner/get-com-banners");
                    ...
                    <div className='row mb-3'>
                        <div className='col-lg-6 d-flex align-items-center'>
                            <CBreadcrumb className="mx-3 mb-0">
                                <CBreadcrumbItem>Company Overview</CBreadcrumbItem>
                            </CBreadcrumb>
                        </div>
                        <div className='col-lg-6 d-flex justify-content-end'>
                            <Link to="/admin/add-com-banner" className='text-decoration-none'>
