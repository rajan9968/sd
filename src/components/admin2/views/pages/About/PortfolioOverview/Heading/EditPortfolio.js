...
export default function EditAboutBanner() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await api.get(`/portfolio-page-heading/get-portfolio-page-heading/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await api.put(`/portfolio-page-heading/update-portfolio-page-heading/${id}`, formData);

            if (response.data.success) {
                toast.success('Portfolio Page Heading updated successfully!');
                setTimeout(() => navigate('/admin/portfolio-page-heading'), 1000);
            } else {
