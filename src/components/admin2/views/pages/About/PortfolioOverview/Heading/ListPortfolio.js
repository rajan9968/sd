...
export default function AboutBannerList() {
    ...
    const handleDelete = (id) => {
        if (window.confirm("Are you sure you want to delete this banner?")) {
            api
                .delete(`/portfolio-page-heading/delete-portfolio-page-heading/${id}`)
                .then((response) => {
...

        {
            ...
            cell: (row) => (
                <div className="d-flex gap-2">
                    <Link
                        to="/admin/edit-portfolio-page-heading"
                        state={{ id: row.id }}
                    >
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await api.get("/portfolio-page-heading/get-portfolio-page-heading");
                ...
                <div className="body flex-grow-1 p-3">
                    ...
                    <div className='row mb-3'>
                        ...
                        <div className='col-lg-6 d-flex justify-content-end'>
                            <Link to="/admin/add-portfolio-page-heading" className='text-decoration-none'>
