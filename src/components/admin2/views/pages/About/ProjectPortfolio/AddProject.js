...
export default function AddAboutBanner() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await api.post('/project/add-project-banner', formData, {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => {
                    navigate('/admin/project-portfolio'); // Redirect to banner list
                }, 1000);
            } else {
                    ...
                    <div className='row bg-white mx-1 mb-3 py-3 shadow-sm'>
                        <div className='col-lg-12 d-flex align-items-center'>
                            <CBreadcrumb className="mb-0">
                                <CBreadcrumbItem>
                                    <Link to="/admin/dashboard" className='text-decoration-none'>Home</Link>/Add Project Portfolio Banner
                                </CBreadcrumbItem>
                            </CBreadcrumb>
                        </div>
                    </div>
