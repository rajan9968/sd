...
export default function AboutBannerList() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await api.get("/about-banner/get-about-banners");
                    ...
                    <div className='row mb-3'>
                        <div className='col-lg-6 d-flex align-items-center'>
                            <CBreadcrumb className="mx-3 mb-0">
                                <CBreadcrumbItem>About Banner</CBreadcrumbItem>
                            </CBreadcrumb>
                        </div>
                        <div className='col-lg-6 d-flex justify-content-end'>
                            <Link to="/admin/add-about-banner" className='text-decoration-none'>
