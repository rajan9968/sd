...
export default function BlogDetailList() {
    ...
    const handleDelete = (id) => {
        if (window.confirm("Are you sure you want to delete this blog?")) {
            api
                .delete(`/blog-detail/delete-blog-detail/${id}`)
                .then((response) => {
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="d-flex gap-2">
                    <Link to="/admin/edit-blog-detail" state={{ id: row.id }}>
                    ...
                    <div className="row mb-3">
                        <div className="col-lg-6 d-flex align-items-center">
                            <CBreadcrumb className="mx-3 mb-0">
                                <CBreadcrumbItem>Blog Detail List</CBreadcrumbItem>
                            </CBreadcrumb>
                        </div>
                        <div className="col-lg-6 d-flex justify-content-end">
                            <Link to="/admin/add-blog-detail" className="text-decoration-none">
