...
export default function PreDevelopment() {
    const slides2 = [
            ...
            try {
                ...
                if (res.data.success) {
                    ...
                    const selected = res.data.banners.find(
                        (item) => item.page_type === "" || item.page_type === "Pre-Development EPC"
                    );
                ...
                console.error("Error fetching Pre-Development EPC data:", error);
            }
        };
            ...
            <main>
                ...
                <section className="join-us our-project py-5">
                    <div className="container-fluid plr">
                        ...
                        <div id="join-carousel-w" className="join-carousel-wrapper custom-donts">
                            <Swiper
